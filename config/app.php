...
return [
    ...
    */
    ...
    'aliases' => Facade::defaultAliases()->merge([
        ...
        'PipeDrive' => App\Facades\PipeDrive::class,
        'RequestLog' => App\Facades\RequestLog::class,
        'FbInsight' => App\Facades\FbInsight::class,
        'Mailchimp' => App\Facades\Mailchimp::class,
        'Slack' => App\Facades\Slack::class,
        'TikTok' => App\Facades\TikTok::class,
        'X' => App\Facades\X::class,
        'GoogleAds' => App\Facades\GoogleAds::class,
    ])->toArray(),

    'frontend-path' => env('APP_FRONTEND_PATH')
];
